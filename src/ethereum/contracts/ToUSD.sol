...
contract ToUSD {
    ...
    string public constant name = "Token of USD"; // solium-disable-line uppercase
    string public constant symbol = "ToUSD"; // solium-disable-line uppercase
