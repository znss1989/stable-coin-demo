...
contract ToCNH {
    ...
    string public constant name = "Token of CNH"; // solium-disable-line uppercase
    string public constant symbol = "ToCNH"; // solium-disable-line uppercase
